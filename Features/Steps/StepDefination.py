...
def step_imp(context):
    context.driver.find_element('name', 'firstname').send_keys("riya")

@when(u'User enters lastname')
def step_imp(context):
    #raise NotImplementedError(u'STEP:User enters lastname')
    context.driver.find_element('name', 'lastname').send_keys("kumARI")
...
def step_imp(context):
     context.driver.find_element('xpath', '//select[@name="birthday_day"]').send_keys("12")

@when(u'User enters year')
def step_imp(context):
     context.driver.find_element('xpath', '//select[@name="birthday_year"]').send_keys("2005")
...
def step_imp(context):
    context.driver.find_element('xpath', '//input[@name="reg_email__"]').send_keys("abc@gmail.com")

@when(u'User enters password')
def step_imp(context):
     context.driver.find_element('xpath', '//input[@name="reg_passwd__"]').send_keys("12345")
...
def step_impl(context):
    raise StepNotImplementedError(u'Then User should be registered  with duplicate email successfully')   
